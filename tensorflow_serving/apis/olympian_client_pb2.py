...
# source: tensorflow_serving/apis/olympian_client.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow_serving/apis/olympian_client.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_pb=_b('\n-tensorflow_serving/apis/olympian_client.proto\x12\x12tensorflow.serving\x1a&tensorflow/core/framework/tensor.proto\x1a#tensorflow_serving/apis/model.proto\x1a%tensorflow_serving/apis/predict.proto2d\n\x0eOlympianClient\x12R\n\x07Predict\x12\".tensorflow.serving.PredictRequest\x1a#.tensorflow.serving.PredictResponseB\x03\xf8\x01\x01\x62\x06proto3')
  ,
...
_OLYMPIANCLIENT = _descriptor.ServiceDescriptor(
  name='OlympianClient',
  full_name='tensorflow.serving.OlympianClient',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='Predict',
    full_name='tensorflow.serving.OlympianClient.Predict',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_OLYMPIANCLIENT)

DESCRIPTOR.services_by_name['OlympianClient'] = _OLYMPIANCLIENT
