...
class OlympianClientStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Predict = channel.unary_unary(
        '/tensorflow.serving.OlympianClient/Predict',
...
class OlympianClientServicer(object):
  # missing associated documentation comment in .proto file
  pass
...
def add_OlympianClientServicer_to_server(servicer, server):
  rpc_method_handlers = {
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'tensorflow.serving.OlympianClient', rpc_method_handlers)
